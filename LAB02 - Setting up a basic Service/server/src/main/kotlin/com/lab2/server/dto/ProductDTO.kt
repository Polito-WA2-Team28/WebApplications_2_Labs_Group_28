...
fun Product.toDTO(): ProductDTO{
    return ProductDTO(deviceType, model, devicePurchaseDate, owner.uuid, warrantyDescription, warrantyExpirationDate, insurancePurchaseDate, insuranceExpirationDate)
}